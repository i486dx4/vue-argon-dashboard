      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <div class="mt-3 d-flex">
          ...
          <div class="form-check form-switch ps-0 ms-auto my-auto">
            <input class="mt-1 form-check-input" :class="isRTL ? 'float-end  me-auto' : ' ms-auto'" type="checkbox"
              id="navbarFixed" :checked="isNavFixed" @click="navbarFixed" />
          </div>
        </div>
        ...
        <button class="btn bg-gradient-dark w-100" @click="closeConfigurator">Close</button>
